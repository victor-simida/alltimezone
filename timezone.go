...
// CommonTimezone ...
var CommonTimezone = map[GmtTz]*time.Location{
	"GMT+02:00": time.FixedZone("GMT+02:00", 3600*2+60*0),
	"GMT+13:00": time.FixedZone("GMT+13:00", 3600*13+60*0),
	"GMT-04:00": time.FixedZone("GMT-04:00", -(3600*4 + 60*0)),
	"GMT+01:00": time.FixedZone("GMT+01:00", 3600*1+60*0),
	"GMT+09:30": time.FixedZone("GMT+09:30", 3600*9+60*30),
	"GMT+10:30": time.FixedZone("GMT+10:30", 3600*10+60*30),
	"GMT+13:45": time.FixedZone("GMT+13:45", 3600*13+60*45),
	"GMT-03:30": time.FixedZone("GMT-03:30", -(3600*3 + 60*30)),
	"GMT-08:00": time.FixedZone("GMT-08:00", -(3600*8 + 60*0)),
	"GMT+11:00": time.FixedZone("GMT+11:00", 3600*11+60*0),
	"GMT-05:00": time.FixedZone("GMT-05:00", -(3600*5 + 60*0)),
	"GMT-06:00": time.FixedZone("GMT-06:00", -(3600*6 + 60*0)),
	"GMT-09:00": time.FixedZone("GMT-09:00", -(3600*9 + 60*0)),
	"GMT+03:00": time.FixedZone("GMT+03:00", 3600*3+60*0),
	"GMT+04:30": time.FixedZone("GMT+04:30", 3600*4+60*30),
	"GMT+06:00": time.FixedZone("GMT+06:00", 3600*6+60*0),
	"GMT+06:30": time.FixedZone("GMT+06:30", 3600*6+60*30),
	"GMT-03:00": time.FixedZone("GMT-03:00", -(3600*3 + 60*0)),
	"GMT-07:00": time.FixedZone("GMT-07:00", -(3600*7 + 60*0)),
	"GMT+05:00": time.FixedZone("GMT+05:00", 3600*5+60*0),
	"GMT+08:30": time.FixedZone("GMT+08:30", 3600*8+60*30),
	"GMT+12:00": time.FixedZone("GMT+12:00", 3600*12+60*0),
	"GMT-09:30": time.FixedZone("GMT-09:30", -(3600*9 + 60*30)),
	"GMT-10:00": time.FixedZone("GMT-10:00", -(3600*10 + 60*0)),
	"GMT-12:00": time.FixedZone("GMT-12:00", -(3600*12 + 60*0)),
	"GMT+03:30": time.FixedZone("GMT+03:30", 3600*3+60*30),
	"GMT+07:00": time.FixedZone("GMT+07:00", 3600*7+60*0),
	"GMT+08:45": time.FixedZone("GMT+08:45", 3600*8+60*45),
	"GMT+10:00": time.FixedZone("GMT+10:00", 3600*10+60*0),
	"GMT-11:00": time.FixedZone("GMT-11:00", -(3600*11 + 60*0)),
	"GMT+05:45": time.FixedZone("GMT+05:45", 3600*5+60*45),
	"GMT+08:00": time.FixedZone("GMT+08:00", 3600*8+60*0),
	"GMT+14:00": time.FixedZone("GMT+14:00", 3600*14+60*0),
	"GMT+04:00": time.FixedZone("GMT+04:00", 3600*4+60*0),
	"GMT+05:30": time.FixedZone("GMT+05:30", 3600*5+60*30),
	"GMT+09:00": time.FixedZone("GMT+09:00", 3600*9+60*0),
	"GMT-01:00": time.FixedZone("GMT-01:00", -(3600*1 + 60*0)),
	"GMT-02:00": time.FixedZone("GMT-02:00", -(3600*2 + 60*0)),
	"GMT+00:00": time.FixedZone("GMT+00:00", 3600*0+60*0),
}

// Map 客户端常用时区列表
var Map = map[string]GmtTz{
